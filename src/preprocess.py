...
FINAL_COLUMNS = ['sentiment', 'reviewText', 'clean_sentiment']
POSITIVES = 17500
TEST_SIZE = 1000
PATH = '../data/baby.json'
...
def start():
    ...
    df['clean_sentiment'] = df['reviewText'].apply(
        lambda x: sentiment_to_words(x))
    ...
    df_train_less, df_test_less = df_final_less[0:
                                                split_idx_], df_final_less[split_idx_:]
